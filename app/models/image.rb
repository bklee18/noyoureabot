class Image
  attr_reader :tag1, :tag2, :tag3, :image_url, :clarifai_access_token
  ...
  def get_clarifai_access_token
    # response = `curl -X POST "https://#{ENV['CLARIFAI_CLIENT_ID']}:#{ENV['CLARIFAI_CLIENT_SECRET']}@https://api.clarifai.com/v1/token/" \ -d "grant_type=client_credentials"`
